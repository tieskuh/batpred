        ...
        for service_template in service_list:
            ...
            if service_name and skip_reason:
                ...
                if not self.base.call_service_wrapper(service_name, **service_data):
                    ...
                    # Only start the repeat_interval keepalive clock for an accepted call, mirroring the
                    # last_service_hash handling below: a rejected call must be retried next cycle, not
                    # rate limited against the timestamp of an attempt that never landed.
